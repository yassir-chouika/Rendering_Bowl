...
"
      ...
      >
        <button
          type="button"
          className="text-white bg-PaletteTeal hover:bg-[#009198] focus:ring-4 focus:ring-[#00ADB5]/50 font-bold rounded-lg text-md px-5 py-2.5 m-5 focus:outline-none motion-opacity-in-0 motion-translate-y-in-100 motion-blur-in-md motion-duration-1000 motion-delay-400 motion-ease-bounce transition-transform hover:scale-105 duration-200"
        >
          Discover
        </button>
      </Link>
