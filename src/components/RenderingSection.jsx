        ...
        <div className="flex flex-row justify-between pt-2 tablet:px-1">
          ...
          <div>
            ...
            <button
              ...
              className="text-white bg-PaletteTeal hover:bg-[#009198] focus:ring-4 focus:ring-[#00ADB5]/50 font-medium rounded-lg text-sm px-4 py-2.5 me-2 m-2 focus:outline-none hover:scale-105 duration-200"
            >
              <FontAwesomeIcon
